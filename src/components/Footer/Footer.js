...
const Footer = () => {
    return (
        <footer className="footer">
                ...
                <div className="custom-container">
                    <div className="footer-top-wrapper">
                        ...
                        <nav className="navigation footer__navigation">
                            ...
                            <Link to="/sign-out" className="navigation__item sign-out">Sign Out</Link>
                        </nav>
                    </div>
                </div>
            </div>
            <div className="custom-container footer-middle">
                <ul className="footer__contacts contacts">
                    <li><Link to="mailto:work.of.future@gmail.com">
                        <svg viewBox="0 0 24 18" className="contacts___icon mail-icon">
                        ...
                        work.of.future@gmail.com</Link></li>
                    <li><Link to="tel:+38 (050) 789 24 98">
                        <svg viewBox="0 0 20 20" version="1.1" className="contacts___icon">
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="phone" transform="translate(-1.000000, -1.000000)" fill="#FFFFFF"
                                   fill-rule="nonzero">
                                    <path
                        ...
                        +38 (050) 789 24 98</Link></li>
                    <li><Link to="tel:+38 (095) 556 08 45">
                        <svg viewBox="0 0 20 20" version="1.1" className="contacts___icon">
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="phone" transform="translate(-1.000000, -1.000000)" fill="#FFFFFF"
                                   fill-rule="nonzero">
            ...
            <div className="custom-container footer-bottom">
                <div className="footer__social">
                    <ul>
                        <li><Link to="/"><img src="./images/social/facebook.svg" alt="facebook"/></Link></li>
                        <li><Link to="/"><img src="./images/social/linkedin.svg" alt="linkedin"/></Link></li>
                        <li><Link to="/"><img src="./images/social/instagram.svg" alt="instagram"/></Link></li>
                        <li><Link to="/"><img src="./images/social/twitter.svg" alt="twitter"/></Link></li>
                        <li><Link to="/"><img src="./images/social/pinterest.svg" alt="pinterest"/></Link></li>
                    </ul>
                </div>
                <p className="footer__copyright">&#169; abz.agency specially for the test task</p>
            </div>
        </footer>
    )
};
